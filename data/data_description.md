...
- Verify energy conservation: total_energy should decay as exp(-2*gamma*t)
- Estimate damping parameters from the displacement envelope
- Compare estimated vs true damping_ratio across oscillators
- Characterize the frequency spectrum of each oscillator
- Identify which oscillators damp fastest / slowest

The first step in the analysis plan should always be a general data loading step common to any idea.
